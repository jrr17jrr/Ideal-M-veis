 ...
 *
 * Os `value` viram query params "amigáveis" em `/produtos`
 * (`?categoria=&ambiente=&preco=&estilo=&mat=&cor=&promo=&disp=`), interpretados
 * por `components/catalog/catalogParams.ts` — mesmo sistema de filtros do catálogo.
 */
...
export const HERO_CATEGORY_OPTIONS: HeroOption[] = [
  ...
  { value: "guarda-roupas", label: "Guarda-roupas" },
...
/** Monta a URL de `/produtos` a partir dos valores do filtro. */
